...
func New(dir Searcher, p Player, st Store, quality domain.QualityPref, tracking string, history bool, theme string, updateCheck bool, volume int, version, updateCacheDir string) Model {
